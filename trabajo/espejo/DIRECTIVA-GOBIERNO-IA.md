...
- Última modificación del `.docx`: **24.08.2026 15:10**
- Párrafos: 393
- Resaltados: {'yellow': 213, 'lightGray': 90, 'green': 39, 'cyan': 67}  ·  amarillo = 1.ª iteración, cian = 2.ª
...
Controles de contención (Guardrails): Conjunto de controles, reglas y mecanismos técnicos para limitar, filtrar o validar las entradas y salidas de un SBIA, previniendo comportamientos no deseados. [NIST AI 600-1 (2024), sección 2.6; OWASP (2025), Top 10 for LLM Applications]
...
| Seguridad de IA | Seg. Informática (INSI) | Efectúa el análisis de riesgo y las pruebas de vulnerabilidad de los SBIA (OSI). |
...
6.1.1	Todo SBIA en la SUNAT sigue un ciclo de vida gestionado con las siguientes etapas:
...
| 2 | Evaluación de viabilidad | La Comisión de Gobierno de IA coordina la evaluación técnica, legal, ética y operativa de la iniciativa y propone la clasificación de riesgo del SBIA, conforme al numeral 6.2. | Aprobación de la clasificación de riesgo y de la viabilidad de la iniciativa, conforme al numeral 6.1.2. |
...
6.2.5	Los controles aplicables a un SBIA se determinan a partir de su clasificación de riesgo, conforme a los numerales 6.6, 6.9 y 6.10, y no son objeto de propuesta ni de negociación. El propietario del caso de uso, con la asistencia técnica de la Comisión de Gobierno de IA, define la forma específica en que dichos controles se implementan en el SBIA. La Comisión de Gobierno de IA verifica su implementación en el hito de aprobación previo al despliegue.
...
6.7.3	Todo SBIA que procese reserva tributaria opera exclusivamente en infraestructura bajo control de la SUNAT.
...
6.9.7	Los lineamientos sobre Transparencia Algorítmica que apruebe la SGTD son de aplicación en la SUNAT desde su entrada en vigencia. La Comisión de Gobierno de IA evalúa su impacto en la presente directiva y propone al CGTD los ajustes que correspondan.
...
El análisis de riesgo y las pruebas de vulnerabilidad sobre cada SBIA corresponden a la Oficina de Seguridad Informática, conforme a la etapa de certificación y validación del numeral 6.1.1. Con la concurrencia de ambas actividades y del monitoreo previsto en el numeral 6.10, la SUNAT satisface la obligación de auditorías de seguridad digital del literal c) del artículo 29 del RLIA. Los resultados de las auditorías alimentan el informe trimestral de la Comisión de Gobierno de IA al CGTD.
...
6.15.5 Las unidades competentes de cada instrumento incorporan en sus documentos normativos la verificación del componente de IA y la opinión de la Comisión, según sus competencias y sin afectar los sistemas administrativos del Estado, conforme al numeral 7.6
...
| 14 | Última auditoría | Fecha de la última auditoría técnica. |
...
Anexo N.° 4: Ficha de Evaluación de Caso de Uso de SBIA
Constituye el contenido mínimo de la evaluación del caso de uso y recoge los datos y las evidencias del problema que sustentan la iniciativa, conforme al numeral 28.4 del artículo 28 del RLIA. Se adecúa a la naturaleza y magnitud de la iniciativa, requerimiento o proyecto, conforme al numeral 6.15.1.
Sección 1 — Identificación:
Denominación del caso de uso.
Unidad de organización solicitante (propietario del caso de uso).
Responsable funcional (nombre, cargo, correo).
Fecha de presentación.
Sección 2 — Problema y justificación:
Descripción del problema o necesidad que se busca resolver.
Situación actual (línea base): volumen de operaciones, tiempo promedio, recursos asignados.
Objetivo estratégico del PEI con el que se alinea (código y denominación).
Sección 3 — Impacto organizacional:
Precisar si la iniciativa genera impacto organizacional e identificar los procesos, áreas, puestos, personas y capacidades técnicas involucrados.
Sección 4 — Generación de valor:
Beneficio esperado cuantificado: horas-persona liberadas, reducción de tiempos de proceso, mejora en tasas de detección, incremento de recaudación estimada u otro indicador medible.
Beneficios cualitativos complementarios (si aplica).
El beneficio puede sustentarse a nivel de un conjunto o programa de SBIA cuando la iniciativa forme parte de un portafolio institucional.
Métrica de éxito propuesta y plazo de medición.
Sección 5 — Inversión y sostenibilidad:
Estimación de inversión inicial (infraestructura, licencias, servicios, horas de desarrollo/servicios de desarrollo).
Estimación de costos recurrentes anuales (operación, mantenimiento, licencias, personal dedicado).
Fuente de financiamiento identificada.
Responsable de la operación y mantenimiento post-despliegue.
Sección 6 — Análisis de alternativas:
¿Se evaluaron soluciones que no requieren IA? Describir.
Justificación de por qué una solución basada en IA es preferible frente a las alternativas.
Sección 7 — Datos y riesgos preliminares:
Datos requeridos (fuentes, tipos, presencia de datos personales o reserva tributaria).
Riesgos preliminares identificados.
Clasificación de riesgo preliminar sugerida por el propietario.
Sección 8 — Firmas:
