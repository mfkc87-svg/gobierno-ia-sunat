...
- Última modificación del `.docx`: **29.07.2026 14:53**
- Párrafos: 388
- Resaltados: {'yellow': 212, 'lightGray': 180, 'cyan': 65}  ·  amarillo = 1.ª iteración, cian = 2.ª
...
5.3.2	Son funciones de la Comisión de Gobierno de IA, en apoyo al CGTD:
Preparar la propuesta de estrategia institucional de IA y sus actualizaciones, para aprobación del CGTD.
Evaluar los casos de uso de SBIA propuestos por los órganos de línea (generación de valor, viabilidad técnica, legal, ética y operativa, y estimación de inversión y costos recurrentes) y elevar al CGTD la recomendación fundamentada de aprobación o no procedencia.
Proponer al CGTD la clasificación de riesgo de cada SBIA, previo al inicio del desarrollo o adquisición.
Asegurar el cumplimiento del Gobierno de IA en la SUNAT.
Coordinar la elaboración de las evaluaciones de impacto algorítmico y elevar sus conclusiones al CGTD.
Administrar el Inventario Institucional de SBIA.
Supervisar el cumplimiento de los hitos de aprobación del ciclo de vida de los SBIA y consolidar los informes de monitoreo, auditoría e incidentes para conocimiento del CGTD.
Proponer lineamientos técnicos complementarios en materia de gobierno de IA y coordinar la articulación con la SGTD-PCM.
Administrar y centralizar la evaluación de los riesgos de los SBIA.
Convocar a otras unidades de organización y a especialistas adicionales según la materia y la complejidad del caso de uso.
...
| Seguridad de IA | Ger. Seg. Información / Of. Seg. Informática (INSI) | Audita los procesos del Sistema de Gestión de Seguridad de la Información que soportan a los SBIA (GSI). Efectúa el análisis de riesgo y las pruebas de vulnerabilidad de los SBIA (OSI). |
...
6.1.4	La Comisión de Gobierno de IA distingue dos situaciones respecto de un caso de uso de SBIA:
Observaciones subsanables (acompañamiento). Cuando la iniciativa presenta debilidades en el análisis de generación de valor, no cuenta con presupuesto identificado o la Ficha de Evaluación de Caso de Uso (Anexo N.° 4) está incompleta, la Comisión de Gobierno de IA brinda acompañamiento al propietario del caso de uso para fortalecer la propuesta antes de elevarla nuevamente. Ninguna iniciativa se descarta por estas causas.
...
6.6.4	Todo SBIA, independientemente de su nivel de riesgo, incorpora medidas proporcionales para prevenir, detectar y corregir resultados discriminatorios o sesgados que puedan afectar a los administrados, conforme al principio de equidad e inclusión de la Política de Uso Seguro, Responsable y Ético de los SBIA. La Comisión de Gobierno de IA verifica la existencia de estas medidas como parte de la evaluación de viabilidad.
...
6.15.3 En los programas y proyectos institucionales conforme al MGPP, cuando se identifique un componente basado en IA se recaba la opinión de la Comisión con carácter previo a la aprobación que corresponda. La obligación aplica en la formulación del caso de negocio; en la elaboración del plan de gestión del proyecto, cuando el detalle de los componentes funcionales revele un componente de IA no previsto; y durante la ejecución, cuando una solicitud de cambio incorpore, sustituya o modifique un componente de IA, aun cuando el cambio no impacte los entregables ni los hitos comprometidos.
