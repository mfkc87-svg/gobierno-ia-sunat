...
- Última modificación del `.docx`: **25.08.2026 11:29**
- Párrafos: 397
- Resaltados: {'yellow': 189, 'lightGray': 77, 'green': 210, 'cyan': 63}  ·  amarillo = 1.ª iteración, cian = 2.ª
...
Riesgo alto: monitoreo continúo automatizado con revisión humana semanal y revisión integral trimestral.
...
6.11.2	El catálogo precisa, para cada herramienta, el ámbito de uso autorizado (uso administrativo general o uso restringido) y si se encuentra desplegada en infraestructura bajo control de la SUNAT. Solo las herramientas desplegadas en dicha infraestructura pueden emplearse con información sujeta a reserva tributaria, conforme al numeral 6.7.3.. La INSI lo publica y lo mantiene actualizado.
...
| 18 | Versión vigente y ultimo cambio | Identificación de la versión del SBIA en producción, fecha del último cambio y su calificación como significativo o no, conforme a los numerales 6.10.4 y 6.10.5 |
